...
function getMarks(students) {
    ...
    const pairs = [
        [students[0] + ' і ' + students[2],themes[0],Math.floor((Math.random() * 5) + 1)],
        [students[1] + ' і ' + students[3],themes[1],Math.floor((Math.random() * 5) + 1)],
        [students[4] + ' і ' + students[5],themes[2],Math.floor((Math.random() * 5) + 1)],
    ]
    return pairs;
}
